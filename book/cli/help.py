...
def preprocess_help(s: str):
    ...
    s = re.sub(r"default: /.*/brontes", "default: <CACHE_DIR>", s)
    # Remove the commit SHA and target architecture triple
    s = re.sub(r"default: brontes/.*-[0-9A-Fa-f]{6,10}/\w+-\w*-\w+", "default: brontes/<VERSION>-<SHA>/<ARCH>", s)
    # Remove the OS
    s = re.sub(r"default: brontes/.*/\w+", "default: brontes/<VERSION>/<OS>", s)
