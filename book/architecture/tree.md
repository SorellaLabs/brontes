...
The Classifier config file is used when an automated discovery process isn't possible. You can simply map a contract address to it's corresponding protocol classifiers so that Brontes can dispatch and classify the trace.
