...
/// SubmitBlockRequestExecutionPayloadOneOfAllOf : The [`ExecutionPayload`](https://github.com/ethereum/consensus-specs/blob/v1.1.9/specs/bellatrix/beacon-chain.md#executionpayload) object from the CL Bellatrix spec.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct SubmitBlockRequestExecutionPayloadOneOfAllOf {
...
impl SubmitBlockRequestExecutionPayloadOneOfAllOf {
    /// The [`ExecutionPayload`](https://github.com/ethereum/consensus-specs/blob/v1.1.9/specs/bellatrix/beacon-chain.md#executionpayload) object from the CL Bellatrix spec.
    pub fn new() -> SubmitBlockRequestExecutionPayloadOneOfAllOf {
