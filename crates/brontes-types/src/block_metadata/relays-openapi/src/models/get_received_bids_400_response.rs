...
pub struct GetReceivedBids400Response {
...
impl GetReceivedBids400Response {
    pub fn new() -> GetReceivedBids400Response {
        GetReceivedBids400Response { code: None, message: None, stacktraces: None }
    }
}
