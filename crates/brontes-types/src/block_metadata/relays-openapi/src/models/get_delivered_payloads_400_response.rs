...
pub struct GetDeliveredPayloads400Response {
...
impl GetDeliveredPayloads400Response {
    pub fn new() -> GetDeliveredPayloads400Response {
        GetDeliveredPayloads400Response { code: None, message: None, stacktraces: None }
    }
}
