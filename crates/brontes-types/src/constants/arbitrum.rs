...
pub const SWAPPER_CONTRACT_ADDRESS: Address =
    Address::new(hex!("4F754e0F0924afD74980886b0B479Fa1D7C58D0D"));
pub const ARBITRUM_SETTLER_CONTRACT_ADDRESS: Address =
    Address::new(hex!("246475E1F63d8e26D6f4fB6029033da8831eD396"));
pub const PARASWAP_AUGUSTUS_CONTRACT_ADDRESS: Address =
    Address::new(hex!("6A000F20005980200259B80c5102003040001068"));
pub const DEBRIDGE_PROXY_CONTRACT_ADDRESS: Address =
    Address::new(hex!("663DC15D3C1aC63ff12E45Ab68FeA3F0a883C251"));
pub const EASY_SWAPPER_CONTRACT_ADDRESS: Address =
    Address::new(hex!("A5679C4272A056Bb83f039961fae7D99C48529F5"));
pub const AXELAR_CONTRACT_ADDRESS: Address =
    Address::new(hex!("2260f6120b634B94A23eF11fa0D615ecf62db3cD"));
pub const GMX_ORDER_HANDLER_CONTRACT_ADDRESS: Address =
    Address::new(hex!("e68CAAACdf6439628DFD2fe624847602991A31eB"));

pub const FILTER_TRANSFER_ADDRESSES: [Address; 9] = [
    LIFI_CONTRACT_ADDRESS,
    ACROSS_CONTRACT_ADDRESS,
    SWAPPER_CONTRACT_ADDRESS,
    ARBITRUM_SETTLER_CONTRACT_ADDRESS,
    PARASWAP_AUGUSTUS_CONTRACT_ADDRESS,
    DEBRIDGE_PROXY_CONTRACT_ADDRESS,
    EASY_SWAPPER_CONTRACT_ADDRESS,
    AXELAR_CONTRACT_ADDRESS,
    GMX_ORDER_HANDLER_CONTRACT_ADDRESS,
];
