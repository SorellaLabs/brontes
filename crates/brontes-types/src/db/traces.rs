...
#[redefined(LogData)]
#[redefined_attr(
    to_source = "LogData::new_unchecked(self.topics.iter().copied().map(Into::into).\
...
#[derive(
    Clone, Debug, Eq, PartialEq, serde::Serialize, rSerialize, rDeserialize, rkyv::Archive, Redefined,
)]
