...
{
    let AsyncAppRunner { context, task_manager, tokio_runtime } = AsyncAppRunner::new()?;
...
impl AsyncAppRunner {
    ...
    fn new() -> Result<Self, std::io::Error> {
        ...
        Ok(Self { context: AppContext { task_executor }, task_manager, tokio_runtime })
    }
}
