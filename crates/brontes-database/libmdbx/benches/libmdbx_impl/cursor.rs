...
#[derive(Debug)]
pub struct LibmdbxCursorBench<T: Table, K: TransactionKind> {
...
impl<T: Table, K: TransactionKind> LibmdbxCursorBench<T, K> {
...
impl<T: Table, K: TransactionKind> DbCursorRO<T> for LibmdbxCursorBench<T, K> {
...
impl<T: DupSort, K: TransactionKind> DbDupCursorRO<T> for LibmdbxCursorBench<T, K> {
...
impl<T: Table> DbCursorRW<T> for LibmdbxCursorBench<T, RW> {
...
impl<T: DupSort> DbDupCursorRW<T> for LibmdbxCursorBench<T, RW> {
