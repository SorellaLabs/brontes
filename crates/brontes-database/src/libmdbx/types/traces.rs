...
use brontes_types::{structured_trace::{TxTrace, DecodedCallData, TransactionTraceWithLogs}, db::redefined_types::primitives::{Redefined_FixedBytes, Redefined_Address, Redefined_Alloy_Bytes, Redefined_U256, Redefined_U64}};
use bytes::BufMut;
...
use reth_rpc_types::trace::parity::{TransactionTrace, Action, CallAction, CallType, CreateAction, SelfdestructAction, RewardType, RewardAction, CallOutput, CreateOutput, TraceOutput};
use redefined::RedefinedConvert;
use brontes_types::db::traces::TxTracesInner;

use serde_with::{serde_as};
use sorella_db_databases::{clickhouse, clickhouse::Row};

use crate::libmdbx::{TxTraces, CompressedTable};
...
#[serde_as]
#[derive(Debug, Default, Clone, Redefined, serde::Serialize, serde::Deserialize, rkyv::Serialize, rkyv::Deserialize, rkyv::Archive)]
...
#[derive(Debug, Clone, Redefined, serde::Serialize, serde::Deserialize, rkyv::Serialize, rkyv::Deserialize, rkyv::Archive)]
#[redefined(TxTrace)]
...
#[derive(Debug, Clone, Redefined, serde::Serialize, serde::Deserialize, rkyv::Serialize, rkyv::Deserialize, rkyv::Archive)]
#[redefined(LogData)]
#[redefined_attr(to_source = "LogData::new_unchecked(self.topics.into_iter().map(Into::into).collect(), self.data.into())")]
...
#[derive(Clone, Debug, Eq, PartialEq, serde::Serialize, serde::Deserialize, rkyv::Serialize, rkyv::Deserialize, rkyv::Archive, Redefined)]
