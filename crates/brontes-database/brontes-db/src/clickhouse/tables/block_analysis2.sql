CREATE TABLE brontes.block_analysis2 ON CLUSTER eth_cluster0  (
    `block_number` UInt64,
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/eth_cluster0/tables/all/brontes/block_analysis2', '{replica}', `last_updated`)
