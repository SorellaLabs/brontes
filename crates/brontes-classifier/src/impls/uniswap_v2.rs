...
mod tests {
    ...
    fn test_uni_v2_mint() {
        ...
        let expected_mint = NormalizedMint {
            ...
            amount:    vec![
                B256::from_low_u64_be(999999641424138).into(),
                B256::from_low_u64_be(1792743).into(),
            ],
        };
    ...
    fn test_uni_v2_swap() {
        ...
        let expected_swap = NormalizedSwap {
            ...
            amount_in:  B256::from_low_u64_be(454788265862552718).into(),
            amount_out: B256::from_low_u64_be(111888798809177).into(),
        };
    ...
    fn t() {
        println!(
            "{:?}",
            Address::from_str("0x3574948e6ba1d48a57f4ade944bc0e4eb20f7d5e")
                .unwrap()
                .0
        );
    }
