...
impl MultiCallFrameClassifier for Cowswap {
    const KEY: [u8; 2] = [Protocol::Cowswap as u8, MultiFrameAction::Batch as u8];
    ...
    fn create_classifier(
        ...
        Some(MultiCallFrameClassification {
            ...
            tree_search_builder: TreeSearchBuilder::new().with_actions([Box::new(Action::is_swap)]),
