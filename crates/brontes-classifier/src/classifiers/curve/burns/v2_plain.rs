...
mod tests {
    ...
    async fn test_curve_v2_plain_pool_remove_liquidity0() {
        ...
        let burn = B256::from(hex!(
            "01263e507a992709a0a53c014ead38c109edc7aa08bc8329a94d051530da8258"
        ));
        ...
        let eq_action = Actions::Burn(NormalizedBurn {
            ...
            amount: vec![
                U256::from(7558238951551444616838 as u128).to_scaled_rational(18),
                U256::from(33415347097773187822792 as u128).to_scaled_rational(18),
            ],
        });
    ...
    async fn test_curve_v2_plain_pool_remove_liquidity_imbalanced0() {
        ...
        let burn = B256::from(hex!(
            "d6ea9a7ee442796536490731fb1236fad076ce6994aeda37735670f3690ad06a"
        ));
        ...
        let eq_action = Actions::Burn(NormalizedBurn {
            ...
            token: vec![token0, token1],
            amount: vec![
                U256::from(827904920210000000000000 as u128).to_scaled_rational(18),
                U256::from(332024620000000000000000 as u128).to_scaled_rational(18),
            ],
        });
    ...
    async fn test_curve_v2_plain_pool_remove_liquidity_one0() {
        ...
        let burn = B256::from(hex!(
            "c6efe6fdf9d1e872765c98730455a9803781958fab7774c48a0be9148ad1165e"
        ));
        ...
        let eq_action = Actions::Burn(NormalizedBurn {
            ...
            pool: Address::new(hex!("9D0464996170c6B9e75eED71c68B99dDEDf279e8")),
            token: vec![token],
            amount: vec![U256::from(915720089431618525538 as u128).to_scaled_rational(18)],
        });
