...
pub enum Curve_TriCrypto_Factory_V2_Enum {
   ...
   add_liquidity_0(Curve_TriCrypto_Factory_V2::add_liquidity_0Call),
   add_liquidity_1(Curve_TriCrypto_Factory_V2::add_liquidity_1Call),
   add_liquidity_2(Curve_TriCrypto_Factory_V2::add_liquidity_2Call),
   ...
   exchange_0(Curve_TriCrypto_Factory_V2::exchange_0Call),
   exchange_1(Curve_TriCrypto_Factory_V2::exchange_1Call),
   exchange_2(Curve_TriCrypto_Factory_V2::exchange_2Call),
   exchange_extended(Curve_TriCrypto_Factory_V2::exchange_extendedCall),
   exchange_underlying_0(Curve_TriCrypto_Factory_V2::exchange_underlying_0Call),
   exchange_underlying_1(Curve_TriCrypto_Factory_V2::exchange_underlying_1Call),
   ...
   remove_liquidity_0(Curve_TriCrypto_Factory_V2::remove_liquidity_0Call),
   remove_liquidity_1(Curve_TriCrypto_Factory_V2::remove_liquidity_1Call),
   remove_liquidity_2(Curve_TriCrypto_Factory_V2::remove_liquidity_2Call),
   remove_liquidity_3(Curve_TriCrypto_Factory_V2::remove_liquidity_3Call),
   remove_liquidity_one_coin_0(Curve_TriCrypto_Factory_V2::remove_liquidity_one_coin_0Call),
   remove_liquidity_one_coin_1(Curve_TriCrypto_Factory_V2::remove_liquidity_one_coin_1Call),
   remove_liquidity_one_coin_2(Curve_TriCrypto_Factory_V2::remove_liquidity_one_coin_2Call),
...
pub enum Curve_Factory1_V1_Enum {
   ...
   add_liquidity_0(Curve_Factory1_V1::add_liquidity_0Call),
   add_liquidity_1(Curve_Factory1_V1::add_liquidity_1Call),
   ...
   calc_withdraw_one_coin_0(Curve_Factory1_V1::calc_withdraw_one_coin_0Call),
   calc_withdraw_one_coin_1(Curve_Factory1_V1::calc_withdraw_one_coin_1Call),
   coins(Curve_Factory1_V1::coinsCall),
   decimals(Curve_Factory1_V1::decimalsCall),
   exchange_0(Curve_Factory1_V1::exchange_0Call),
   exchange_1(Curve_Factory1_V1::exchange_1Call),
   ...
   remove_liquidity_0(Curve_Factory1_V1::remove_liquidity_0Call),
   remove_liquidity_1(Curve_Factory1_V1::remove_liquidity_1Call),
   remove_liquidity_imbalance_0(Curve_Factory1_V1::remove_liquidity_imbalance_0Call),
   remove_liquidity_imbalance_1(Curve_Factory1_V1::remove_liquidity_imbalance_1Call),
   remove_liquidity_one_coin_0(Curve_Factory1_V1::remove_liquidity_one_coin_0Call),
   remove_liquidity_one_coin_1(Curve_Factory1_V1::remove_liquidity_one_coin_1Call),
...
pub enum Curve_Meta_Factory1_V1_Enum {
   ...
   add_liquidity_0(Curve_Meta_Factory1_V1::add_liquidity_0Call),
   add_liquidity_1(Curve_Meta_Factory1_V1::add_liquidity_1Call),
   ...
   exchange_0(Curve_Meta_Factory1_V1::exchange_0Call),
   exchange_1(Curve_Meta_Factory1_V1::exchange_1Call),
   exchange_underlying_0(Curve_Meta_Factory1_V1::exchange_underlying_0Call),
   exchange_underlying_1(Curve_Meta_Factory1_V1::exchange_underlying_1Call),
   ...
   remove_liquidity_0(Curve_Meta_Factory1_V1::remove_liquidity_0Call),
   remove_liquidity_1(Curve_Meta_Factory1_V1::remove_liquidity_1Call),
   remove_liquidity_imbalance_0(Curve_Meta_Factory1_V1::remove_liquidity_imbalance_0Call),
   remove_liquidity_imbalance_1(Curve_Meta_Factory1_V1::remove_liquidity_imbalance_1Call),
   remove_liquidity_one_coin_0(Curve_Meta_Factory1_V1::remove_liquidity_one_coin_0Call),
   remove_liquidity_one_coin_1(Curve_Meta_Factory1_V1::remove_liquidity_one_coin_1Call),
...
pub enum Curve_Factory2_V1_Enum {
   ...
   add_liquidity_0(Curve_Factory2_V1::add_liquidity_0Call),
   add_liquidity_1(Curve_Factory2_V1::add_liquidity_1Call),
   ...
   exchange_0(Curve_Factory2_V1::exchange_0Call),
   exchange_1(Curve_Factory2_V1::exchange_1Call),
   ...
   remove_liquidity_0(Curve_Factory2_V1::remove_liquidity_0Call),
   remove_liquidity_1(Curve_Factory2_V1::remove_liquidity_1Call),
   remove_liquidity_imbalance_0(Curve_Factory2_V1::remove_liquidity_imbalance_0Call),
   remove_liquidity_imbalance_1(Curve_Factory2_V1::remove_liquidity_imbalance_1Call),
   remove_liquidity_one_coin_0(Curve_Factory2_V1::remove_liquidity_one_coin_0Call),
   remove_liquidity_one_coin_1(Curve_Factory2_V1::remove_liquidity_one_coin_1Call),
...
pub enum Curve_Crypto_V2_Enum {
   ...
   add_liquidity_0(Curve_Crypto_V2::add_liquidity_0Call),
   add_liquidity_1(Curve_Crypto_V2::add_liquidity_1Call),
   add_liquidity_2(Curve_Crypto_V2::add_liquidity_2Call),
   ...
   exchange_0(Curve_Crypto_V2::exchange_0Call),
   exchange_1(Curve_Crypto_V2::exchange_1Call),
   exchange_2(Curve_Crypto_V2::exchange_2Call),
   exchange_extended(Curve_Crypto_V2::exchange_extendedCall),
   exchange_underlying_0(Curve_Crypto_V2::exchange_underlying_0Call),
   exchange_underlying_1(Curve_Crypto_V2::exchange_underlying_1Call),
   ...
   remove_liquidity_0(Curve_Crypto_V2::remove_liquidity_0Call),
   remove_liquidity_1(Curve_Crypto_V2::remove_liquidity_1Call),
   remove_liquidity_2(Curve_Crypto_V2::remove_liquidity_2Call),
   remove_liquidity_one_coin_0(Curve_Crypto_V2::remove_liquidity_one_coin_0Call),
   remove_liquidity_one_coin_1(Curve_Crypto_V2::remove_liquidity_one_coin_1Call),
   remove_liquidity_one_coin_2(Curve_Crypto_V2::remove_liquidity_one_coin_2Call),
...
pub enum Curve_Crypto_Factory_V2_Enum {
   ...
   add_liquidity_0(Curve_Crypto_Factory_V2::add_liquidity_0Call),
   add_liquidity_1(Curve_Crypto_Factory_V2::add_liquidity_1Call),
   add_liquidity_2(Curve_Crypto_Factory_V2::add_liquidity_2Call),
   ...
   exchange_0(Curve_Crypto_Factory_V2::exchange_0Call),
   exchange_1(Curve_Crypto_Factory_V2::exchange_1Call),
   exchange_2(Curve_Crypto_Factory_V2::exchange_2Call),
   exchange_extended(Curve_Crypto_Factory_V2::exchange_extendedCall),
   exchange_underlying_0(Curve_Crypto_Factory_V2::exchange_underlying_0Call),
   exchange_underlying_1(Curve_Crypto_Factory_V2::exchange_underlying_1Call),
   ...
   remove_liquidity_0(Curve_Crypto_Factory_V2::remove_liquidity_0Call),
   remove_liquidity_1(Curve_Crypto_Factory_V2::remove_liquidity_1Call),
   remove_liquidity_2(Curve_Crypto_Factory_V2::remove_liquidity_2Call),
   remove_liquidity_one_coin_0(Curve_Crypto_Factory_V2::remove_liquidity_one_coin_0Call),
   remove_liquidity_one_coin_1(Curve_Crypto_Factory_V2::remove_liquidity_one_coin_1Call),
   remove_liquidity_one_coin_2(Curve_Crypto_Factory_V2::remove_liquidity_one_coin_2Call),
